...
export const Register = () => {
  ...
  async function handleRegister(event){
    ...
    try{
      ...
      toast.error('Registro Fallido',error.message, {closeButton: true, position: "bottom-center"});
